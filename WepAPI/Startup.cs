...
namespace WepAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<IProductService,ProductManager>(); // Arka Planda bizim yerimize newler.
            //services.AddSingleton<IProductDal,EfProductDal>(); // Arka Planda bizim yerimize newler.
